...
var resizePizzas = function(size) { 
 ...
 //old function
  // If we output to console:  console.log("new width: " + newwidth); in a loop we will find that the size of pizzaContainer is same 
...
var pizzasDiv = document.getElementById("randomPizzas");                                // assign pizzasDiv to variable outside the loop could not find much iumprovement
for (var i = 2; i < 100; i++) {
...
function updatePositions() {
  ...
  var scrollTop = document.body.scrollTop;                                                       // assign scrollTOp property to varibale to increase perfomance
